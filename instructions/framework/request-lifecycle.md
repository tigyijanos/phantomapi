...
6. Read only the entity, storage, config, and framework files required by that endpoint.
...
9. Write observability outputs.
10. Return the final JSON response only.
