...
- update counters for total requests, successful requests, failed requests, rate-limit failures, auth failures, storage failures, repair attempts, repair successes, and repair failures
...
- metrics counters: `totalRequests`, `successfulRequests`, `failedRequests`, `rateLimitFailures`, `authFailures`, `storageFailures`, `repairAttempts`, `repairSuccesses`, `repairFailures`
